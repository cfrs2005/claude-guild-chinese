...
本章介绍 Claude Code 的核心概念和导航系统，帮助你理解这个强大工具的基础架构。

## 🎯 本章概览

Claude Code 是一个智能编程助手，通过自然语言交互帮助开发者完成各种编程任务。本章将带你了解：
...
项目根目录的 `CLAUDE.md` 文件是 Claude Code 理解项目的关键：
...
1. **清晰的描述** - 具体说明你想要实现的功能
2. **上下文提供** - 确保 Claude 了解项目背景
3. **迭代开发** - 分步骤实现复杂功能
4. **验证反馈** - 测试每个步骤的结果
...
完成本章后，你将了解 Claude Code 的基本概念和使用方法。

**继续学习**: [第二章 斜杠命令和集成系统](02-斜杠命令和集成系统.html)
